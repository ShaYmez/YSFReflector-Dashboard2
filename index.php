...
<head>
    ...
    <title><?php echo htmlspecialchars(defined("DASHBOARD_NAME") ? DASHBOARD_NAME : "YSF Reflector Dashboard", ENT_QUOTES, 'UTF-8'); ?> - <?php echo htmlspecialchars(getConfigItem("Info", "Name", $configs), ENT_QUOTES, 'UTF-8'); ?></title>
    ...
    <div class="container mx-auto px-4 py-8">
            ...
            <div class="flex flex-col lg:flex-row items-center justify-between">
                <div class="flex-1">
                    <h1 class="text-4xl font-bold mb-2 bg-clip-text text-transparent bg-gradient-to-r from-blue-200 to-purple-200">
                        <?php echo htmlspecialchars(defined("DASHBOARD_NAME") ? DASHBOARD_NAME : "YSF Reflector Dashboard", ENT_QUOTES, 'UTF-8'); ?>
                    </h1>
        ...
        <div class="grid grid-cols-1 lg:grid-cols-2 gap-8 mb-8">
            ...
            <div class="card-glossy p-6">
                ...
                <div class="space-y-4">
                    ...
                    <div class="flex justify-between items-center py-3 border-b border-white/10">
                        <span class="text-white/80">YSFReflector Version</span>
                        <span class="font-semibold text-sm"><?php echo getYSFReflectorVersion(); ?></span>
                    </div>
        ...
        <div class="card-glossy p-6 text-center">
            <div class="text-sm text-white/80">
                ...
                echo "YSFReflector-Dashboard2 V".VERSION." | Last Reload ".$lastReload->format('Y-m-d, H:i:s')." (".TIMEZONE.")";
                $time = microtime();
                $time = explode(' ', $time);
                $time = $time[1] + $time[0];
                $finish = $time;
            ...
            <div class="mt-3">
                <a href="https://github.com/ShaYmez/YSFReflector-Dashboard2" target="_blank" class="text-blue-400 hover:text-blue-300 underline text-sm">
